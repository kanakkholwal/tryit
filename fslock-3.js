                ...
                $(document).ready(function(){
                  ...
                  if (_GET('u') && $(config.output).length) {
                    ...
                    if (typeof(data) === "object") {
                      ...
                      $(config.output)[0].innerHTML = '<form id="locked"><div class="input-group flex-nowrap"><span class="input-group-text" id="go2form"><i class="fas fa-lock fa-fw"></i></span><input   aria-describedby="go2form"  class="form-control" name="pass" type="password" id="passin" onclick="sUp(\'#report\')" onkeypress="sUp(\'#report\')" aria-label="Password" /><button class="btn btn-success" id='passin' type="submit">Unlock</button></div></form><section class="trans" style="overflow: hidden;height: 0"><div id="report"></div></section>';
                    }
                  } else {
